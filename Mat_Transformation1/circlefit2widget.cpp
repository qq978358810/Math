...
void CircleFit2Widget::slot_executeClicked()
{
    ...
    //代数求解
    _arcConfig config  = GlobleAlgorithm::getInstance()->Get_ArcCenter1(coord1 ,coord2, rad);
    m_textEdit->append(QString("代数推导: 圆心1坐标: (%1,%2) --- 圆心2坐标: (%3,%4) --- 圆的半径: %5")
                           ...
                           .arg(config.raio));
    //几何求解
    _arcConfig config1  =GlobleAlgorithm::getInstance()->Get_ArcCenter2(coord1 ,coord2, rad);
